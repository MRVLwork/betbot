...
TEXTS = {'ua': {'start': 'Вітаю 👋\nОбери дію:',
        ...
        'choose_stats_type': '📊 Статистика  обери розділ:',
        ...
        'send_screen_with_limit': '📤 Надішли скрін ставки\n'
                                  '\n'
                                  'Ліміт на сьогодні: {limit}\n'
                                  'Використано: {used}\n'
                                  'Залишилось: {remaining}',
        'account_info': '📈 Інформація по акаунту\n'
                        '\n'
                        'Тариф: {plan}\n'
        ...
        'stats_result': '📊 Моя статистика ({period})\n'
                        '\n'
                        '💰 Прибуток: {net_profit}\n'
                        '📈 ROI: {roi}%\n'
                        ...
                        '\n'
                        '🔥 Серія: {win_streak}',
        'full_stats_result': '📈 Повна статистика ({period})\n'
                             '\n'
                             '💰 Прибуток: {net_profit}\n'
                             '📈 ROI: {roi}%\n'
                             '🎯 % виграшних ставок: {win_rate}%\n'
                             ...
                             '📉 Останні 5 ставок:\n'
                             '{last_results}',
        'analytics_result': '🧠 Аналітика ({period})\n'
                            '\n'
                            '📊 Розподіл:\n'
        ...
        'bet_market_1x2': '1X2',
        'bet_market_total': 'Тотал',
        'bet_market_btts': "Обидві заб'ють",
        'bet_market_handicap': 'Фора',
        'bet_market_double_chance': '1X/2X',
        'bet_market_corners': 'Кутові',
        'bet_market_cards': 'Картки',
        'bet_market_other': 'Інше',
        ...
        'profile_aggressive_desc': 'Ти часто граєш коефіцієнти 2 і вище. Це підвищує ризик і робить результат менш '
                                   'стабільним.',
        'profile_balanced_title': 'Збалансований гравець',
        'profile_balanced_desc': 'Ти рівномірно використовуєш різні коефіцієнти. Баланс хороший, але варто перевіряти, '
                                 'що реально дає прибуток.',
        ...
        'full_stats_result_vip': '📈 VIP Повна статистика ({period})\n'
                                 ...
                                 'Результат: {result_type_count} | прибуток {result_type_profit} | ROI '
                                 '{result_type_roi}%\n'
                                 '\n'
                                 '📈 По коефіцієнтах\n'
        ...
        'analytics_weak_market_line': 'Ринок: {label} | ROI {roi}% | Profit {profit}',
        ...
        'analytics_strength_market': '— найкраще працює ринок: {label}',
        ...
        'analytics_no_market_data': 'Поки що немає даних по ринках ставок за вибраний період.',
        'analytics_recommendation_focus_market': 'Найближчим часом краще змістити фокус у бік ринку: {market} — зараз '
                                                 'він дає кращий результат.',
        ...
        'analytics_recommendation_cut_high_odds': 'Скороти частку ставок з коефіцієнтами 2.5+ і сфокусуйся на '
                                                  'стабільніших сегментах.',
        'analytics_recommendation_focus_total': 'Найближчим часом краще змістити фокус у бік тоталів — вони дають '
                                                'кращий результат.',
        'analytics_recommendation_focus_result': 'Зараз результативніші ставки на результат — варто підсилити саме цей '
                                                 'напрямок.',
        'analytics_recommendation_reduce_risk': 'При серії поразок зменшуй ризик і не підвищуй агресивність гри.',
        'analytics_recommendation_keep_discipline': 'Продовжуй поточну дисципліну й спостерігай, який сегмент ставок '
                                                    'тримає ROI вище.',
        ...
        'usdt_screenshot_received': "✅ Скрін отримано.\n\nТепер натисни кнопку 'Я оплатив'.",
        'usdt_no_pending_payment': 'Не знайдено активної заявки на оплату. Спочатку обери тариф.',
        'usdt_payment_sent': '✅ Заявка на перевірку оплати прийнята.\n'
                             '\n'
        ...
        'stars_payment_success': '✅ Оплата успішна.\nТариф: {title}\nДоступ активовано на {days} днів.',
        'bet_analysis_started': '🤖 Аналізую ставку.',
        'bet_saved': '✅ Ставку розпізнано і збережено\n'
                     '\n'
        ...
        'bet_pending_saved': '🕒 Ставку збережено як нерозраховану\n'
                             '\n'
                             '📌 Тип ставки: {bet_type}\n'
                             '💰 Сума ставки: {stake_amount}\n'
                             '📊 Коефіцієнт: {odds}\n'
        ...
        'buy_access_push': '🚀 Повний доступ дає:\n'
                           ...
                           '\n'
                           '👇 Обери тариф',
        'ai_analysis_no_access': '🔒 AI-аналіз доступний лише після активації підписки.\n\n👇 Обери тариф:',
        'ai_analysis_send_prompt': '🤖 AI Аналіз матчу\n'
                                   '\n'
                                   'Надішли скрін події з БК або сайту аналітики. Також можна надіслати назву матчу '
                                   'текстом.\n'
                                   '\n'
                                   'Я проаналізую видиму інформацію і сформую короткий огляд матчу для прийняття '
                                   'рішення.',
        'ai_analysis_processing': '🤖 Аналізую подію та формую огляд матчу...',
        'ai_analysis_failed': '❌ Не вдалося сформувати AI огляд матчу.\n'
                              'Спробуй інший скрін або надішли чіткіший.\n'
                              '\n'
                              'DEBUG: {error}',
        'ai_analysis_done_hint': '📩 Можеш надіслати ще один скрін події або знову відкрити AI Аналіз.',
        'ai_analysis_no_match': '❌ Не вдалося впевнено визначити матч із цього скріну.\n'
                                'Спробуй надіслати інший скрін або назву матчу текстом.'},
 'ru': {'start': 'Привет 👋\nВыбери действие:',
        ...
        'choose_stats_type': '📊 Статистика  выберите раздел:',
        ...
        'send_screen_with_limit': '📤 Отправь скрин ставки\n'
                                  '\n'
                                  'Лимит на сегодня: {limit}\n'
                                  'Использовано: {used}\n'
                                  'Осталось: {remaining}',
        'account_info': '📈 Информация по аккаунту\n'
                        '\n'
                        'Тариф: {plan}\n'
                        'Доступ до: {access_until}\n'
                        '\n'
        ...
        'stats_result': '📊 Моя статистика ({period})\n'
                        ...
                        '\n'
                        '🔥 Серия: {win_streak}',
        'full_stats_result': '📈 Полная статистика ({period})\n'
                             '\n'
                             '💰 Прибыль: {net_profit}\n'
                             '📈 ROI: {roi}%\n'
                             '🎯 % выигрышных ставок: {win_rate}%\n'
                             ...
                             '📉 Последние 5 ставок:\n'
                             '{last_results}',
        'analytics_result': '🧠 Аналитика ({period})\n'
                            '\n'
                            '📊 Распределение:\n'
                            'Тотал: {total_type_count}\n'
                            'Результат: {result_type_count}\n'
        ...
        'bet_market_1x2': '1X2',
        'bet_market_total': 'Тотал',
        'bet_market_btts': 'Обе забьют',
        'bet_market_handicap': 'Фора',
        'bet_market_double_chance': '1X/2X',
        'bet_market_corners': 'Угловые',
        'bet_market_cards': 'Карточки',
        'bet_market_other': 'Другое',
        ...
        'profile_careful_desc': 'Ты чаще играешь коэффициенты до 2. Это дает более стабильный, но более медленный '
                                'рост.',
        'profile_aggressive_title': 'Агрессивный игрок',
        'profile_aggressive_desc': 'Ты часто играешь коэффициенты 2 и выше. Это повышает риск и делает результат менее '
                                   'стабильным.',
        'profile_balanced_title': 'Сбалансированный игрок',
        'profile_balanced_desc': 'Ты равномерно используешь разные коэффициенты. Баланс хороший, но стоит проверять, '
        ...
        'full_stats_result_vip': '📈 VIP Полная статистика ({period})\n'
                                 ...
                                 'Результат: {result_type_count} | прибыль {result_type_profit} | ROI '
                                 '{result_type_roi}%\n'
                                 '\n'
                                 '📈 По коэффициентам\n'
                                 '<2.0 : {odds_lt2_count} ставок | {odds_lt2_profit} | ROI {odds_lt2_roi}%\n'
        ...
        'analytics_stability_block': 'Текущая серия побед: {current_win_streak}\n'
                                     ...
                                     'Худшая серия поражений: {worst_lose_streak}',
        'analytics_weak_type_line': 'Тип ставок: {label} | ROI {roi}% | Profit {profit}',
        'analytics_weak_market_line': 'Рынок: {label} | ROI {roi}% | Profit {profit}',
        ...
        'analytics_strength_market': '— лучше всего работает рынок: {label}',
        ...
        'analytics_no_market_data': 'Пока нет данных по рынкам ставок за выбранный период.',
        'analytics_recommendation_focus_market': 'В ближайшее время лучше сместить фокус в сторону рынка: {market} — '
                                                 'сейчас он даёт лучший результат.',
        ...
        'analytics_recommendation_cut_high_odds': 'Сократи долю ставок с коэффициентами 2.5+ и сфокусируйся на более '
                                                  'стабильных сегментах.',
        'analytics_recommendation_focus_total': 'В ближайшее время лучше сместить фокус в сторону тоталов — они дают '
                                                'лучший результат.',
        'analytics_recommendation_focus_result': 'Сейчас лучше работают ставки на результат — стоит усилить именно это '
                                                 'направление.',
        'analytics_recommendation_reduce_risk': 'При серии поражений снижай риск и не повышай агрессивность игры.',
        'analytics_recommendation_keep_discipline': 'Сохраняй текущую дисциплину и наблюдай, какой сегмент ставок '
                                                    'держит ROI выше.',
        ...
        'usdt_screenshot_received': "✅ Скрин получен.\n\nТеперь нажми кнопку 'Я оплатил'.",
        'usdt_no_pending_payment': 'Не найдена активная заявка на оплату. Сначала выбери тариф.',
        'usdt_payment_sent': '✅ Заявка на проверку оплаты принята.\n'
                             '\n'
        ...
        'stars_payment_success': '✅ Оплата успешна.\nТариф: {title}\nДоступ активирован на {days} дней.',
        'bet_analysis_started': '🤖 Анализирую ставку.',
        'bet_saved': '✅ Ставка распознана и сохранена\n'
                     '\n'
                     '🎯 Результат: {bet_result}\n'
                     '📌 Тип ставки: {bet_type}\n'
        ...
        'bet_pending_saved': '🕒 Ставка сохранена как нерассчитанная\n'
                             '\n'
                             '📌 Тип ставки: {bet_type}\n'
                             '💰 Сумма ставки: {stake_amount}\n'
                             '📊 Коэффициент: {odds}\n'
                             ...
                             'Осталось сегодня: {remaining}/{limit}',
        'bet_parse_failed': '❌ Не удалось распознать ставку со скрина.\n'
        ...
        'trial_intro_push': '🚀 Пробный доступ активирован!\n'
                            '\n'
        ...
        'trial_after_first_push': '📊 Первый результат уже есть.\n'
                                  '\n'
        ...
        'trial_after_third_push': '📊 У тебя уже есть первые данные для выводов.\n'
                                  '\n'
        ...
        'trial_limit_push': '❌ Лимит достигнут ({used}/{limit})\n'
                            '\n'
        ...
        'buy_access_push': '🚀 Полный доступ даёт:\n'
                           '\n'
                           '📊 Полную статистику\n'
                           '🧠 Глубокую аналитику\n'
                           ...
                           '\n'
                           '👇 Выбери тариф',
        'ai_analysis_no_access': '🔒 AI-анализ доступен только после активации подписки.\n\n👇 Выбери тариф:',
        'ai_analysis_send_prompt': '🤖 AI Анализ матча\n'
                                   '\n'
                                   'Отправь скрин события из БК или сайта аналитики. Также можно отправить название '
                                   'матча текстом.\n'
                                   '\n'
                                   'Я проанализирую видимую информацию и сформирую короткий обзор матча для принятия '
                                   'решения.',
        'ai_analysis_processing': '🤖 Анализирую событие и формирую обзор матча...',
        'ai_analysis_failed': '❌ Не удалось сформировать AI обзор матча.\n'
                              'Попробуй другой скрин или отправь более чёткий.\n'
                              '\n'
                              'DEBUG: {error}',
        'ai_analysis_done_hint': '📩 Можешь отправить ещё один скрин события или снова открыть AI Анализ.',
        'ai_analysis_no_match': '❌ Не удалось уверенно определить матч по этому скрину.\n'
                                'Попробуй отправить другой скрин или название матча текстом.'},
 'en': {'start': 'Hello 👋\nChoose an action:',
        ...
        'choose_stats_type': '📊 Statistics  choose section:',
        ...
        'daily_limit_reached': '⛔ Daily limit reached.\n'
                               ...
                               'Try again tomorrow.',
        'send_screen_with_limit': '📤 Send a bet screenshot\n'
                                  '\n'
                                  "Today's limit: {limit}\n"
                                  'Used: {used}\n'
                                  'Remaining: {remaining}',
        ...
        'stats_result': '📊 My stats ({period})\n'
                        ...
                        '\n'
                        '🔥 Streak: {win_streak}',
        'full_stats_result': '📈 Full stats ({period})\n'
                             '\n'
                             '💰 Profit: {net_profit}\n'
                             '📈 ROI: {roi}%\n'
                             '🎯 Win rate: {win_rate}%\n'
                             ...
                             '📉 Last 5 bets:\n'
                             '{last_results}',
        'analytics_result': '🧠 Analytics ({period})\n'
                            '\n'
                            '📊 Distribution:\n'
                            'Total: {total_type_count}\n'
                            'Result: {result_type_count}\n'
        ...
        'bet_market_1x2': '1X2',
        'bet_market_total': 'Total',
        'bet_market_btts': 'Both teams to score',
        'bet_market_handicap': 'Handicap',
        'bet_market_double_chance': '1X/2X',
        'bet_market_corners': 'Corners',
        'bet_market_cards': 'Cards',
        'bet_market_other': 'Other',
        ...
        'profile_aggressive_desc': 'You often choose odds of 2 and above. This increases risk and makes results less '
                                   'stable.',
        'profile_balanced_title': 'Balanced player',
        'profile_balanced_desc': 'You use different odds quite evenly. The balance is good, but it is worth checking '
        ...
        'analytics_weak_market_line': 'Market: {label} | ROI {roi}% | Profit {profit}',
        ...
        'analytics_strength_market': '— strongest market: {label}',
        ...
        'analytics_no_market_data': 'There is no market data for the selected period yet.',
        'analytics_recommendation_focus_market': 'For now, it is better to shift focus toward the {market} market — it '
                                                 'is producing the better result right now.',
        ...
        'analytics_recommendation_focus_total': 'For now it is better to shift focus toward totals — they bring a '
                                                'better result.',
        'analytics_recommendation_focus_result': 'Result bets are working better right now — it makes sense to '
        ...
        'analytics_recommendation_keep_discipline': 'Keep your current discipline and watch which segment holds ROI '
                                                    'higher.',
        ...
        'usdt_screenshot_received': "✅ Screenshot received.\n\nNow press the 'I paid' button.",
        'usdt_no_pending_payment': 'No active payment request found. Choose a plan first.',
        'usdt_payment_sent': '✅ Payment verification request accepted.\n'
                             '\n'
        ...
        'bet_saved': '✅ Bet recognized and saved\n'
                     '\n'
                     '🎯 Result: {bet_result}\n'
                     '📌 Bet type: {bet_type}\n'
        ...
        'bet_pending_saved': '🕒 Bet saved as unsettled\n'
                             '\n'
                             '📌 Bet type: {bet_type}\n'
                             '💰 Stake amount: {stake_amount}\n'
                             '📊 Odds: {odds}\n'
        ...
        'trial_after_first_push': '📊 You already have your first result.\n'
                                  '\n'
                                  'Even 1 screenshot already shows more than most players see in a week.\n'
                                  '\n'
                                  '👉 Send a few more bets — let’s build the full picture.',
        'trial_after_third_push': '📊 You already have the first data for conclusions.\n'
                                  '\n'
        ...
        'trial_limit_push': '❌ Limit reached ({used}/{limit})\n'
                            '\n'
        ...
        'buy_access_push': '🚀 Full access gives you:\n'
                           '\n'
                           '📊 Full statistics\n'
                           '🧠 Deep analytics\n'
                           ...
                           '\n'
                           '👇 Choose a plan',
        'ai_analysis_no_access': '🔒 AI analysis is available only after activating a subscription.\n\n👇 Choose a plan:',
        'ai_analysis_send_prompt': '🤖 AI Match Analysis\n'
                                   '\n'
                                   'Send an event screenshot from a bookmaker or analytics website. You can also send '
                                   'the match name as text.\n'
                                   '\n'
                                   'I will analyze the visible information and build a short match report for decision '
                                   'making.',
        'ai_analysis_processing': '🤖 Analyzing the event and building the match report...',
        'ai_analysis_failed': '❌ Failed to build the AI match report.\n'
                              'Try another screenshot or send a clearer one.\n'
                              '\n'
                              'DEBUG: {error}',
        'ai_analysis_done_hint': '📩 You can send one more event screenshot or open AI Analysis again.',
        'ai_analysis_no_match': '❌ I could not confidently identify the match from this screenshot.\n'
                                'Try another screenshot or send the match name as text.'}}
