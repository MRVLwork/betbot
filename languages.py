TEXTS = {
    "ua": {
        ...
        "analytics_recommendation_focus_market": "Найближчим часом краще змістити фокус у бік ринку: {market} — зараз він дає кращий результат.",
    ...
    "ru": {
        ...
        "analytics_recommendation_focus_market": "В ближайшее время лучше сместить фокус в сторону рынка: {market} — сейчас он даёт лучший результат.",
    ...
    "en": {
        ...
        "analytics_recommendation_focus_market": "For now, it is better to shift focus toward the {market} market — it is producing the better result right now.",
