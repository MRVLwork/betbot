TEXTS = {
    "ua": {
        ...
        "analytics_recommendation_focus_market": "Найкраще зараз працює ринок {label} — варто тримати фокус саме на ньому.",
    ...
    "ru": {
        ...
        "analytics_recommendation_focus_market": "Лучше всего сейчас работает рынок {label} — стоит держать фокус именно на нём.",
    ...
    "en": {
        ...
        "analytics_recommendation_focus_market": "The market {label} is working best for you right now — it makes sense to keep your focus there.",
